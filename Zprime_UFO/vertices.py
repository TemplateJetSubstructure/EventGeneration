...
V_1 = Vertex(name = 'V_1',
             particles = [ P.c__tilde__, P.c, P.Zpl ],
             color = [ 'Identity(1,2)' ],
             lorentz = [ L.FFV1 ],
             couplings = {(0,0):C.GC_10})

V_2 = Vertex(name = 'V_2',
             particles = [ P.u__tilde__, P.u, P.Zpl ],
             color = [ 'Identity(1,2)' ],
             lorentz = [ L.FFV1 ],
             couplings = {(0,0):C.GC_10})
...
V_36 = Vertex(name = 'V_36',
              particles = [ P.d__tilde__, P.d, P.Zph ],
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFV1 ],
              couplings = {(0,0):C.GC_10})

V_37 = Vertex(name = 'V_37',
              particles = [ P.s__tilde__, P.s, P.Zph ],
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFV1 ],
              couplings = {(0,0):C.GC_10})

V_38 = Vertex(name = 'V_38',
              particles = [ P.b__tilde__, P.b, P.Zph ],
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFV1 ],
              couplings = {(0,0):C.GC_10})

V_39 = Vertex(name = 'V_39',
              particles = [ P.d__tilde__, P.d, P.Zpl ],
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFV1 ],
              couplings = {(0,0):C.GC_10})

V_40 = Vertex(name = 'V_40',
              particles = [ P.s__tilde__, P.s, P.Zpl ],
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFV1 ],
              couplings = {(0,0):C.GC_10})

V_41 = Vertex(name = 'V_41',
              particles = [ P.b__tilde__, P.b, P.Zpl ],
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFV1 ],
              couplings = {(0,0):C.GC_10})
...
V_81 = Vertex(name = 'V_81',
              particles = [ P.u__tilde__, P.u, P.Zph ],
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFV1 ],
              couplings = {(0,0):C.GC_10})

V_82 = Vertex(name = 'V_82',
              particles = [ P.c__tilde__, P.c, P.Zph ],
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFV1 ],
              couplings = {(0,0):C.GC_10})

V_83 = Vertex(name = 'V_83',
              particles = [ P.t__tilde__, P.t, P.Zph ],
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFV1 ],
              couplings = {(0,0):C.GC_10})
